...
function avatar() {
  return {
    link: function(scope, element, attr) {
      attr.$observe('avatar', function() {
        if (!attr.avatar) {
          element.attr("src", "img/broken.jpg");
        } else {
          var thumb = attr.avatar.replace('public','');
          element.attr("src", API_END_POINT + thumb);
          element.removeAttr("avatar");
        }
      });
    }
  };
